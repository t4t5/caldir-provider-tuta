...
impl EntityClient {
	...
	async fn post_instance_changes(
		...
		let has_custom_id = matches!(
			entity_id,
			ElementValue::IdCustomId(_) | ElementValue::IdTupleCustomElementId(_)
		);
